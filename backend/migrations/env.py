...
from app.models import activity, blogger_city, blogger_group, config, duplicate, keyword_group, note, poster, report, schedule, search_usage, task, user  # noqa: F401
