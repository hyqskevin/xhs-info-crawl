...
# 2026-09-02 audit batch 3 P2-2:
# similarity_score / classify_similarity / merge_activities 已从 dedup 模块删除,
# 这三个函数无生产调用方(只剩本测试),删函数连删测试。
...
@pytest.mark.parametrize("message", [
    ...
    # 2026-08-22 task28 SECURITY_BLOCK 反馈
    "Xiaohongshu security block: the note detail page was blocked by risk control.",
    "error_code=300013 error_msg=访问频繁，请稍后再试",
    "risk control triggered, please try later",
])
