...
const mocks = vi.hoisted(() => ({ tasks: vi.fn().mockResolvedValue({ data: { data: { items: [{ id: 8, type: 'mixed', status: 'COMPLETED_WITH_ERRORS', total_notes: 10, downloaded_notes: 7, ocr_notes: 7, extracted_notes: 7, success_notes: 7, failed_notes: 1, skipped_notes: 2, current_stage: null, error_message: '一条失败' }] } } }), logs: vi.fn() }))
