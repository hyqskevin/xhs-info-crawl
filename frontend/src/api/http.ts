...
http.interceptors.response.use(r=>r,e=>{if(e.response?.status===401&&location.pathname!='/login'){localStorage.removeItem('token');location.href='/login'}return Promise.reject(e)})
