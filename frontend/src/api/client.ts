...
export const api={
  ...
  activities:(params={})=>http.get('/activities',{params}),activity:(id:number)=>http.get(`/activities/${id}`),updateActivity:(id:number,data:object)=>http.put(`/activities/${id}`,data),deleteActivity:(id:number)=>http.delete(`/activities/${id}`),
