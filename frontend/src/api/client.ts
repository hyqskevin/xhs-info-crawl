...
export const api={
  ...
  tasks:()=>http.get('/tasks'),createTask:(data:object)=>http.post('/tasks/crawl',data),restartTask:(id:number)=>http.post(`/tasks/${id}/restart`),logs:(id:number)=>http.get(`/tasks/${id}/logs`),
